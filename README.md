...
- [ ] Выполнить задание из списка "задач" 13_diffOfArrays.js
- [ ] Выполнить задание из списка "задач" 14_spinWords.js
- [ ] Выполнить задание из списка "задач" 15_numberOfVowels.js
____
## План
