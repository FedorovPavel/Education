...
/*
    Из примеров выше, заметно, что объект-дата позволяет автоматически исправить 
    ошибки установки частей даты и времени, перенося либо на следующий компонент
...
//  Помимо методов получения из объекта-даты существуют методы получения даты или времени или того
