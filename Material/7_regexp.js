...
/**
    №9. Заменить в тексте text все телефонные номера на ##########
*/
{
    let text = 'Это мой номер телефона 79998883322, не потеряй его';
}

/**
    №10. Заменить в тексте text2 все знаки(не цифры и не буквы) на пробелы 
*/
{
    let text2 = 'Прототип нового сервиса - это как ласковый перезвон. Вертикали власти!';
}

/**
    №11. Заменить в тексте text3 все ссылки вида http:// или https:// на "котик" (Сложное)
*/
{
    let text3 = `Вот ссылка на материалы о charCodeAt: https://developer.mozilla.org/ru/doc-s/Web/JavaScript/Reference/Global_Objects/String/charCodeAt Но там может быть реклама.
    Кстати а ты знаешь что разработчике firefox, которая доступна по ссылке https://www.mozilla.org/ru/firefox/ специально собирают всю информацию в виде сборника. У них еще есть roadmap фронтенд технологий https://developer.mozilla.org/ru/docs/Web
    Все фронтенд разработчики должны знать https://caniuse.com/`;
